package com.example.lotterydbrouter.router.config;


import com.example.lotterydbrouter.router.DBRouterConfig;
import com.example.lotterydbrouter.router.DBRouterJoinPoint;
import com.example.lotterydbrouter.router.dynamic.DynamicDataSource;
import com.example.lotterydbrouter.router.dynamic.DynamicMybatisPlugin;
import com.example.lotterydbrouter.router.strategy.IDBRouterStrategy;
import com.example.lotterydbrouter.router.strategy.impl.DBRouterStrategyHashCode;
import com.example.lotterydbrouter.router.util.PropertyUtil;
import com.example.lotterydbrouter.router.util.StringUtils;
